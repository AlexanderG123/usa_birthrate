...
write_csv(x = simulated_data, file = "outputs/data/sim_fig_1.csv")
...
simulated_data2
write_csv(x = simulated_data2, file = "outputs/data/sim_fig_4.csv")
...
write_csv(x = simulated_data3, file = "outputs/data/sim_fig_2e.csv")
...
write_csv(x = simulated_data4, file = "outputs/data/sim_fig_5.csv")
