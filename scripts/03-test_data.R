...
#test fig_1 data
data1 = read_csv("~/usa_birthrate/inputs/data/fig_1.csv")
...
#test fig_2e data 
data2 = read_csv("~/usa_birthrate/inputs/data/fig_2e.csv")
#test all data is inbetween 1980 and 2020
...
#test fig_4 data
data3 = read_csv("~/usa_birthrate/inputs/data/fig_4.csv")
...
#test fig_5 data
data4 = read_csv("~/usa_birthrate/inputs/data/fig_5.csv")
